...
translate schinese Damp_Cave_b33d9683:

    # k "You're back, are you prepared now."
    k "你回来了。"

translate schinese Damp_Cave_c6f965f5:

    # k "I don't want to carry you out of the cave again."
    k "这次必须给我准备好，我不想再扛着你出来。"

translate schinese Damp_Cave_239b9b42:

    # e "Yes, let's keep going."
    e "当然，你放心，我们继续前进吧。"

translate schinese Damp_Cave_38c18d0d:

    # k "I should have drafted my guards instead."
    k "早知就不该挑你打帮手，我的士兵随便抽一个都比你强得多。"

translate schinese Damp_Cave_0e185163:

    # e "H-hey, I'm a good fighter..."
    e "嘿，之前只是发生了一点小意外……"

translate schinese Damp_Cave_40e45012:

    # "The general stays silent, staring at you blankly."
    "羊族将军冷若冰霜地盯着你，沉默良久。"

translate schinese Damp_Cave_63b608f3:

    # e "I-I am!"
    e "真、真的！快走吧，将军。"

translate schinese Damp_Cave_0af21bee:

    # e "Alright, General."
    pass

translate schinese Damp_Cave_9f919637:

    # k "You're back."
    k "你回来了。"

translate schinese Damp_Cave_d42aa91e:

    # e "Yes, let's continue with the cave."
    e "嗯哼，我们继续前进吧。"

translate schinese Damp_Cave_40e45012_1:

    # "The general stays silent, staring at you blankly."
    "羊族将军冷若冰霜地盯着你，沉默良久。"

translate schinese Damp_Cave_6d7f824b:

    # k "I shouldn't wait for you."
    k "我就不该傻傻待在原地等你。"

translate schinese Damp_Cave_6ab0a3b3:

    # e "Look we can save Furkan together, alright?"
    e "嘿，相信我们会一起救出弗坎的，好吗？"

translate schinese Damp_Cave_9373df6d:

    # k "...if you go out one more time I'm going to kill you myself."
    k "……要是你再临阵脱逃，我会亲手宰了你。"

translate schinese Damp_Cave_0af21bee_1:
...
translate schinese Damp_Cave_Puddle_c56c97f0:

    # "You drank the water, it seems to have healed you to full health."
    "你喝下蓝水，它似乎完全回复了你的体力。"

translate schinese Damp_Cave_Puddle_8bfbef95:

    # "But your Lust almost increased by 20."
    "但你的性欲随之增长了 20 点。"

translate schinese Damp_Cave_Puddle_feb65ab0:

    # e "Uhm... that made me feel so hot right now."
    e "唔……喝了感觉身体好热。"

translate schinese Damp_Cave_Puddle_ddbc5ca2:

    # k "W-what?"
    k "怎么了？"

translate schinese Damp_Cave_Puddle_9b94ae94:

    # e "I drank the water."
    e "我喝了那滩水。"

translate schinese Damp_Cave_Puddle_7d2893ae:

    # k "You drank from a dirty puddle on the ground, are you stupid?"
    k "你是傻子吗？怎么敢喝地上的脏水。"

translate schinese Damp_Cave_Puddle_7256839b:

    # e "Sorry..."
    e "对不起……"

translate schinese Damp_Cave_Puddle_d229b5e3:

    # "After drinking from the stagnant puddle, you decide to leave."
    "你擦掉嘴角的水渍，转身离开了这滩水。"

translate schinese Damp_Cave_Shelf_5a31dcf4:

    # e "Oh, there's a bookshelf here for some reason."
    e "嘿，那里竟然有个书架。"

translate schinese Damp_Cave_Shelf_2a8468ee:

    # "As you are searching around the bookshelf, you found out that most of the books are all unreadable..."
    "你随意抽出其中的书籍翻阅，可惜没几本你能读懂的……"

translate schinese Damp_Cave_Shelf_db731995:

    # "But after skimming through most of the shelf, there is a strip of paper that seems to be newer."
    "扫视整个书架，你发现了一张看起来年代比较晚的纸。"

translate schinese Damp_Cave_Shelf_73e13418:

    # k "Uhm, What did it say...?"
    k "嗯……纸上写了什么？"

translate schinese Damp_Cave_Shelf_ba0eff63:

    # e "Let me see."
    e "我看看。"

translate schinese Damp_Cave_Shelf_16401e07:

    # "You read from the paper..."
    "你努力辨识着纸上的字迹……"

translate schinese Damp_Cave_Shelf_2651c84d:

    # "'T/e blessi/g of Tapj/o: Date/ Year 12/07...'"
    # The blessing of Tapjoo: Date/ Year 12/07...
    e "闼丕瓯之恩泽，七年十二月……"

translate schinese Damp_Cave_Shelf_6442032d:

    # "'Accor/ding to the research by the King's a//isor, Kjarr Eli//.'"
    # Accorrding to the research by the King's advisor, Kjarr Elias.
    e "安王室咨义师谢尔爱莲……总之是个人——所考，近日羊氏之邑凯奇奥伦旁有爆发，或因不明魔力所致。"

translate schinese Damp_Cave_Shelf_9594d69a:

    # "'The recent explosion near Kechi//ren ({i}Goat Tr/be/{/i}, seems to /e caused by an unkn//n magi/al force.'"
    # The recent explosion near Kechioeren ({i}Goat Tribe{/i}), seems to be caused by an unknown magical force.
    pass

translate schinese Damp_Cave_Shelf_ad6f399b:
    ...
    # This force... of what the locals called {i}the Blessing of the Running Goat{/i}. Has been speculated to contaminate the water source.
    e "此力为乡人所称……什么疾羝之恩泽，疑为苍耀湖受亏——受污之故。"

translate schinese Damp_Cave_Shelf_cc4fb772:
    ...
    # The aforementioned water now appears to display a bright blue glow after the explosion, while providing healing power to the drinker.
    e "爆发后湖水色青，饮有了——疗效而其弊未明……"

translate schinese Damp_Cave_Shelf_7ac33039:

    # "'It is /nknown if ther/ exists any possible side effect.'"
    # It is unknown if there exists any possible side effect.
    pass

translate schinese Damp_Cave_Shelf_c2ecef11:
    ...
    e "今羊氏之长格、格米——格克代米尔拒与吾方合作。"

translate schinese Damp_Cave_Shelf_c6fa7ecc:

    # "The piece of paper gets cut off here."
    "你手中残卷到此为止。"

translate schinese Damp_Cave_Shelf_8c89c538:

    # e "Uhm... what a weird piece of information. Who actually writes like that."
    e "呃……读起来真费脑筋。怎么有人会这么写文章。"

translate schinese Damp_Cave_Shelf_97e6a665:

    # k "Is it talking about our Tribe?"
    k "上面说的是我们部落吗？"

translate schinese Damp_Cave_Shelf_92f16cc0:

    # e "Yeah."
    e "对。"

translate schinese Damp_Cave_Shelf_5baea47a:

    # k "Goekdemir is Furkan's Great-Grandfather, at least they got it right."
    k "格克代米尔是弗坎的曾曾祖父，至少上面没写错名字。"

translate schinese Damp_Cave_Shelf_a0961606:

    # k "Otherwise, I consider it nothing but gibberish. You should do so as well."
    k "至于其他内容，我建议你也把它当胡扯。"

translate schinese Damp_Cave_Shelf_1b5a6720:

    # e "Oh... It is."
    e "噢……这样啊。"

translate schinese Damp_Cave_Shelf_0e98079c:

    # "You put the piece of paper back to the bookshelf."
    "你将这张纸塞回原位。"

translate schinese Damp_Cave_Shelf_63bd4eda:

    # "You also discovered a recipe for a plain bandana among the books."
    "与此同时，你还找到了一份花头巾的缝纫工艺清单。"

translate schinese Damp_Cave_Shelf_e246719a:

    # e "A plain bandana uses 2 fabric and 1 strap..."
    e "缝制花头巾需要用到 2 块布料和 1 条皮带……"

translate schinese Damp_Cave_Shelf_e254de6d:

    # "After looking into the books, you decide you have discovered everything readable."
    "再翻阅几本书后，你确信自己没有遗漏任何有用的信息了。"

translate schinese Damp_Cave_Chest_b9fb7400:

    # "You run into a chest in the cave, you walk towards it, trying to open it anything possible."
    "你跑向宝箱，迫不及待地想知道里面藏着什么好东西。"

translate schinese Damp_Cave_Chest_4921e600:

    # "You discovered 100 gold, and 2 strength potions inside the chest."
    "好彩，你收获了 100 枚金币和 2 瓶力量药水。"

translate schinese Damp_Cave_Chest_dee24fa2:

    # "You discovered 80 gold, 4 pieces of iron ingot and a recipe for canvas inside the chest."
    "好彩，你收获了 80 枚金币、4 块铁锭、1 份帆布的制作工艺清单。"

translate schinese Damp_Cave_Chest_9f2e69f7:

    # e "To make a canvas, you need... 3 hemps and 2 straps, got it."
    e "制作帆布需要用到……3 束大麻和 2 条皮带。我明白了。"

translate schinese Damp_Cave_Chest_2b03842f:

    # e "Uhm... Kari? You want the stuff inside the chest?"
    e "呃……卡里？宝箱里的这些……"

translate schinese Damp_Cave_Chest_39c62512:

    # k "Keep it, Courier. I just want to save Furk."
    k "你自己留着吧。我只想救出弗坎。"

translate schinese Damp_Cave_Chest_ceca3aac:
