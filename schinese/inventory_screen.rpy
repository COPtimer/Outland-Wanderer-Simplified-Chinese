translate schinese strings:
    ...
    new "暴击系数 [crit_damage]"

    old "Gold: [pc.gold]"
    new "金币 [pc.gold]"

    old "Level Point: [pc.lvluppt]"
    new "属性点 [pc.lvluppt]"

    old "Flirt: [pc.lust_damage]"
    new "诱惑 [pc.lust_damage]"

    old "Lust Resist: [pc.lust_defense]"
    ...
    new "魅力值（CHA）决定了[e]对其他角色的吸引程度，主要影响诱惑效果。"
