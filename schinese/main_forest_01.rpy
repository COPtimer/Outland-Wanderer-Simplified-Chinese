...
translate schinese main_woodland_outpost_94e12146:
    ...
    k "还有这份铁剑和铁斧的制作方法，应该对你很有用，拿去吧。"

translate schinese main_woodland_outpost_44668cc5:
...
translate schinese ancient_tree_chop_176da485:
    ...
    "你的剩余体力不足以支撑伐木产生的损伤，你决定最好先去别处瞧瞧。"

translate schinese ancient_tree_chop_a229b0ad:
...
translate schinese sparkling_lagoon_drink_1778dec4:
    ...
    "你翻了翻背包，没找到可以用来装水的容器。你失望地离开了湖边，想着要是带个小木桶来就好了。"

translate schinese sparkling_lagoon_drink_d45e1edf:
    ...
    "你干巴巴望着湖水，灌了好几桶水的你已经撑不下更多了。你想着自己需要先让肚子吸收一段时间再来。"
...
translate schinese green_forest_loop_6795ba31:
    ...
    "你走着走着，刚刚还悄无声息的灌木丛突然窜出一团绿色粘液粘住了你。"

translate schinese green_forest_loop_ef997b7d:
    ...
    "你拼命甩着胳膊，想把这团粘液甩掉。你才看清这是一团绿史莱姆。"

translate schinese green_forest_loop_ec9039c2:
    ...
    "你漫步叠翠森林，注意到艳阳下一抹艳红在灌木丛中摇曳，你走近将红莓摘下。"

translate schinese green_forest_loop_3a490989:

    # "You put the red berry in your bag, you now have [item_number] red berry."
    "你将红莓放进背包，现在你持有 [item_number] 把红莓。"

translate schinese green_forest_loop_88e4ec00:

    # "You put the red berry in your bag, you now have [item_number] red berries."
    "你将红莓放进背包，现在你持有 [item_number] 把红莓。"

translate schinese green_forest_loop_7f533c9c:
...
translate schinese green_forest_loop_89ec9253:
    ...
    "你走着走着，一条满是落叶的泥路引起了你的注意，这条路似乎已经荒弃很久了，不过路面却有一段新鲜的足迹。"

translate schinese green_forest_loop_a49cea3d:
    ...
    "你沿着小路走向他处，几分钟后你来到了一片密林。一棵参天古树生长在密林正中间，你驻足观望。"

translate schinese green_forest_loop_e59928dc_1:

    # "You look around the green forest for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese green_forest_loop_511df20f:
    ...
    "你走着走着，突然左脚撞到了什么东西，你往下看，发现是一块石头。"

translate schinese green_forest_loop_e1ac0667:

    # e "It must be the rock... no, stone that Sebas asked me to collect."
    e "这一定是塞巴斯要我捡回去的东西。"

translate schinese green_forest_loop_18961dfc:

    # e "I think I have enough ...stone now. I gotta go back and report to Sebas."
    e "我捡的石头已经够多了……我应该回去找塞巴斯交作业。"

translate schinese green_forest_loop_e7c8eaf3:
...
translate schinese ancient_tree_loop_90ff1c7f:
    ...
    "你漫步古树周围，注意到艳阳下一抹金黄在灌木丛中摇曳，你走近将金莓摘下。"
...
translate schinese sparkling_lagoon_loop_752145e3:
    ...
    "你走过湖边，注意到脚边有一丛花，你弯腰将亚麻花折下。"

translate schinese sparkling_lagoon_loop_bde92c53:

    # "You put the flax flower in your bag, you now have [item_number] flax flower."
    "你将亚麻放进背包，现在你持有 [item_number] 束亚麻。"

translate schinese sparkling_lagoon_loop_c2ae7326:

    # "You put the flax flower in your bag, you now have [item_number] flax flowers."
    "你将亚麻放进背包，现在你持有 [item_number] 束亚麻。"

translate schinese sparkling_lagoon_loop_0c517644:
    ...
    "你漫步苍耀湖，注意到艳阳下一抹艳红在灌木丛中摇曳，你走近将红莓摘下。"

translate schinese sparkling_lagoon_loop_3a490989:

    # "You put the red berry in your bag, you now have [item_number] red berry."
    "你将红莓放进背包，现在你持有 [item_number] 把红莓。"

translate schinese sparkling_lagoon_loop_88e4ec00:

    # "You put the red berry in your bag, you now have [item_number] red berries."
    "你将红莓放进背包，现在你持有 [item_number] 把红莓。"

translate schinese sparkling_lagoon_loop_e3eefdaf:
    ...
    "你漫步苍耀湖，注意到艳阳下一抹幽蓝在灌木丛中摇曳，你走近将蓝莓摘下。"

translate schinese sparkling_lagoon_loop_b2dcd073:

    # "You put the blue berry in your bag, you now have [item_number] blue berry."
    "你将蓝莓放进背包，现在你持有 [item_number] 把蓝莓。"

translate schinese sparkling_lagoon_loop_c44940ab:
...
translate schinese sparkling_lagoon_loop_e91ba75d_1:
...
# translate schinese mossy_freshwater_loop_b4f1ef41:

#     # "You use the trowel you brought with you, and dig through the smooth sand and mud underwater."
#     ""

# translate schinese mossy_freshwater_loop_06a740d9:

#     # "Soon, the hole becomes deep enough that you notice a branch glowing blue."
#     ""

# translate schinese mossy_freshwater_loop_9e9f2c2c:

#     # "With a little push, you pull out the branch, and feel a powerful aura coursing through your body..."
#     ""

# translate schinese mossy_freshwater_loop_bc4d7076:

#     # "It must be a trinket."
#     ""

# translate schinese mossy_freshwater_loop_f0df0c49:

#     # "You carefully put it in your bag. And step away from the water."
#     ""

# translate schinese mossy_freshwater_loop_7a4dea47_1:

#     # "You try to dig through the mud with your bare hand... but to no avail, it seems to not work."
#     ""

# translate schinese mossy_freshwater_loop_0ba9ac66_1:
...
translate schinese woodland_outpost_loop_b9952a9e:
    ...
    "你正在哨站四处探索，不料一个巨大的身影冲了出来，将你扑倒在地。"

translate schinese woodland_outpost_loop_e4ba1378:
    ...
    "他棕色的身躯连同身上防具压迫着你，你好不容易挣开了束缚。"

translate schinese woodland_outpost_loop_716e94fa:
    ...
    "是熊地精！你立马起身，看清了这头怪物的全貌。熊地精手握狼牙锤，朝你愤怒地咆哮。"

translate schinese woodland_outpost_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese woodland_outpost_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese woodland_outpost_loop_48fb9183:

    # "As you look around the woodland, you notice there's an unusual shadow at the peripheral of your sight."
    "你环顾林地，远处一个诡异的身影引起了你的注意。你急忙转身面向他。"

translate schinese woodland_outpost_loop_a6e00f15:

    # "You turn to the figure, its mass encapsulating your view. You notices its antler, and the eyes behind its mask."
    "他同时也注意到了你，朝你走来。"
    "这个身影愈发庞大，一对鹿角率先拉开树荫叠成的帷幕，展露出面具之下的凌厉目光。"

translate schinese woodland_outpost_loop_8e39c3eb:

    # "The sight is... familiar in some twisted way, you feel like you have been in this situation before."
    "历史总是惊人的相似……你回想起那一晚。"

translate schinese woodland_outpost_loop_dd733f9a:

    # "Stranded at night in the forest, being chased by a mysterious figure."
    "同样独自探索森林，同样被神秘人追赶的那一晚。"

translate schinese woodland_outpost_loop_b21316a8:
...
translate schinese woodland_outpost_loop_32516365:
...
translate schinese woodland_outpost_loop_70890ddc:
    ...
    e "他身上长满了苔藓，我就在那边遇到他的。"

translate schinese woodland_outpost_loop_db425602:
...
translate schinese woodland_outpost_loop_b629b50c:

    # "After walking along the forest for a while, you decide to go deeper into the forest."
    "随便逛了一会后，你决定这次往深处走走。"

translate schinese woodland_outpost_loop_b40e55d3:

    # "You discovered that the tree seems to be denser than before, almost covering the sky above."
    "越往深处走，周围的树木愈发密集，枝叶愈发茂盛，几乎遮住了整片天空。"

translate schinese woodland_outpost_loop_e91ba75d_3:
...
translate schinese damp_cave_loop_e91ba75d:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese damp_cave_loop_e91ba75d_1:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese damp_cave_loop_e91ba75d_2:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese damp_cave_loop_e91ba75d_3:

    # "You search around the area for a while, but there seem to be nothing worth noting nearby."
    "你找了又找，但周围似乎没有什么值得关注的东西了。"

translate schinese damp_cave_loop_e91ba75d_4:
